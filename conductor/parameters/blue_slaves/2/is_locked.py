...
from current_controller.devices import blue_slave_2
from update.proxy import UpdateProxy
from twisted.internet.reactor import callInThread


class IsLocked(ConductorParameter, blue_slave_2.BlueSlave2Proxy):
    autostart = True
    priority = 1
    call_in_thread = True
    ...
    def initialize(self, config):
        ...
        self._update = UpdateProxy('blue_slave_2')
