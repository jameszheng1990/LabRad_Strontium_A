...
class AndorServer(ThreadedServer):
    ...
    @setting(17, serial='i', returns='ivvv')
    ...
    @setting(69, serial='i', returns='iii')
    def get_temperature_range(self, c, serial):
        self._set_serial(serial)
        mintemp, maxtemp = andor.GetTemperatureRange()
        error_code = andor.error['GetTemperatureRange']
        return error_code, mintemp, maxtemp

    @setting(70, serial='i', returns='iv')
    def get_read_out_time(self, c, serial):
        self._set_serial(serial)
        readoutTime = andor.GetReadOutTime()
        error_code = andor.error['GetReadOutTime']
        return error_code, readoutTime
